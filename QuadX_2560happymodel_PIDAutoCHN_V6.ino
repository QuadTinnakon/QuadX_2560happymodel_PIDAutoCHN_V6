...
//////////////////////////////////////////////////     
      ...
      float temp_vz = accrZ_Earth + (baro_vz - vz_hat2)*0.45 + (Altitude_barof - Altitude_hat)*3.72;//Altitude_barof Altitude_Baro_ult 4.72 ,,0.95
      vz_hat2 = vz_hat2 + temp_vz*G_Dt;
      vz_hat = constrain(vz_hat2, -4, 4);//+-4 m/s
      applyDeadband(vz_hat, 0.04);//+-0.01 m/s
      float temp_hz = vz_hat + (Altitude_barof - Altitude_hat)*6.72;//4.72 12.54 4.5
