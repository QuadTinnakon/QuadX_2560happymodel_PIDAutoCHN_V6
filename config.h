...
#define MINTHROTTLE 1150 //1180 1105 1090
...
float Kd_rateRoll = 0.075;//0.065 0.085 0.025 - 0.045

float Kp_ratePitch = 1.08;//1.18 5.28
float Ki_ratePitch = 0.82;//2.75 0.5 - 2.8
float Kd_ratePitch = 0.075;//0.065 0.078 0.025 - 0.045
...
float Ka_altitude = 32.5;//32.5 38.5 41.5 35 25 - 45
...
int M_X_MIN = -512;    //-654  -693   -688
int M_X_MAX = 350;     //185   209    170
int M_Y_MIN = -625;    //-319  -311   -310
int M_Y_MAX = 300;     //513   563    546
int M_Z_MIN = -440;    //-363  -374   -377
int M_Z_MAX = 410;     //386   429    502
////////////////////////////////////////////////////////////////////
//Observer hz
